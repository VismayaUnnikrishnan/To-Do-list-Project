...
heading=Label(root,text="ALL TASK", font="arial 20 bold",fg="red",bg="#32405b")
heading.place(x=130,y=20)

#icon
Image_icon=PhotoImage(file="image/topbar.png")
...
button=Button(frame,text="ADD", font="arial 20 bold",width=6,fg="#fff",bg="#5a95ff",bd=0)
...
Button(root,image=Delete_icon,bd=0).pack(side=BOTTOM,pady=12)
